...
{
    public class MissingChildDetailsRepository : GenericRepository<TblMissingChildDetail>, IMissingChildDetails
    {
        private readonly AhmCityDrDbContext _context;

        public MissingChildDetailsRepository(AhmCityDrDbContext context) : base(context)
        {
            _context = context;
        }
        ...
        public IEnumerable<MissingChildDetailsViewModel> GetMissingChildDetails(int roleId, int sectorId, int zoneId, int divisionId, int policeStationId, DateTime fromDate, DateTime toDate)
        {
            ...
            return _context.Set<MissingChildDetailsViewModel>()
                           .FromSqlRaw("exec USP_View_tblMissingChildDetails_SEL @RoleId, @SectorId, @ZoneId, @DivisionId, @PoliceStationId, @FromDate, @ToDate", pRoleId, pSectorId, pZoneId, PDivisionId, pPoliceStationId, pFromDate, pToDate)
                           .ToList();
        }
    }
}
