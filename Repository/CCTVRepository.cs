...
{
    public class CCTVRepository : GenericRepository<TblCctvMaster>, ICCTV
    {
        ...
        public CCTVRepository(AhmCityDrDbContext context) : base(context)
        {
            _context = context;
        }
        ...
        {
            _context.Database.ExecuteSqlRaw($"USP_tblCCTV_DEL {id}");
        }
        ...
        public IEnumerable<CCTVViewModel> GetCCTV(int roleId, int sectorId, int zoneId, int divisionId, int policeStationId, DateTime fromDate, DateTime toDate)
        {
            ...
            return _context.Set<CCTVViewModel>().FromSqlRaw("exec USP_tblCCTV_SEL @RoleId, @SectorId, @ZoneId, @DivisionId, @PoliceStationId, @FromDate, @ToDate", pRoleId, pSectorId, pZoneId, PDivisionId, pPoliceStationId, pFromDate, pToDate).ToList();
        }
