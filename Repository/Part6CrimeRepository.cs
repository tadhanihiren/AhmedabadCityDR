...
{
    public class Part6CrimeRepository : GenericRepository<TblPart1_5Crime>, IPart6Crime
    {
        ...
        public Part6CrimeRepository(AhmCityDrDbContext context) : base(context)
        {
            _context = context;
        }
        ...
        /// <summary>
        /// Gets Part 6 Crimes by police satation
        /// /// </summary>
        /// <param name="roleId">Role ID</param>
        /// <param name="sectorId">Sector ID</param>
        /// <param name="zoneId">Zone ID</param>
