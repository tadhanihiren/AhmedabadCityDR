...
function PopulateSearchPoliceStationDRD() {
    $.getJSON("/Api/ApiCommon/GetPoliceStation", function (data) {
        $.each(data, function (index, row) {
            //console.log(row);
            $("#searchPoliceStationId").append("<option value='" + row.policeStationId + "'>" + row.policeStationName + "</option>");
            $("#policeStationId").append("<option value='" + row.policeStationId + "'>" + row.policeStationName + "</option>");
        });
    });
}
