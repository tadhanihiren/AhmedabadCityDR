...
$(document).ready(function () {
    ...
    $('#data_Aksmat_death').DataTable({
        ...
        "columns": [
            ...
            { title: 'મરણ જનાર નુ નામ સરનામું', data: 'accused', "width": "900px" },
            { title: 'બનાવ બ.તા.ટા.', data: 'gubatata', "width": "200px" },
            { title: 'બનાવ જા.તા.ટા', data: 'gujatata', "width": "200px" },
            { title: 'બનાવ દા.તા.ટા', data: 'gudatata', "width": "200px" },
